...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (cursorDot && cursorOutline && window.innerWidth > 1024) {
        ...
        // Lerp loop for outline inertia
        const speed = 0.15; // smoothness multiplier
        ...
        const hoverTargets = document.querySelectorAll("a, button, .project-card, .skills-card, .timeline-card, .soft-skill-tag, .stat-card, .social-badge, .contact-method-item");
